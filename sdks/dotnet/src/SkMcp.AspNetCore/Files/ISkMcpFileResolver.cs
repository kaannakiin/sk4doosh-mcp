...
namespace SkMcp.AspNetCore.Files;
...
/// <summary>
/// Turns a <c>ref</c> file argument into bytes. sk-mcp names no storage: registering this service
/// is what makes <c>ref</c> appear in a file argument's schema.
/// </summary>
public interface ISkMcpFileResolver
{
