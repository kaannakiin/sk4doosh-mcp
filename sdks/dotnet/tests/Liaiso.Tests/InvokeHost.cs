...
public abstract class InvokeHost : IAsyncLifetime
{
    ...
    private LiaisoMetaTools _tools = null!;
    ...
    public async Task InitializeAsync()
    {
        ...
        _tools = new LiaisoMetaTools(
            _app.Services.GetRequiredService<LiaisoCatalogProvider>(),
            _app.Services.GetRequiredService<LiaisoDispatcher>(),
            ...
            _app.Services.GetRequiredService<IOptions<LiaisoOptions>>(),
            new FixedContext(new DefaultHttpContext()),
            _app.Services.GetRequiredService<ILogger<LiaisoMetaTools>>());
    }
