...
/// LIAISO_PARITY_DIR names the output directory; the comparison itself is
...
public sealed class OpenApiParityDump
{
    ...
    {
        string? directory = Environment.GetEnvironmentVariable("LIAISO_PARITY_DIR");
        ...
        builder.Services.AddLiaiso(options => options.Selection.Default = SelectionDefault.Include);
        ...
        LiaisoCatalogProvider catalog = app.Services.GetRequiredService<LiaisoCatalogProvider>();
