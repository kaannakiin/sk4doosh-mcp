...
public sealed class ErrorMappingTests
{
    ...
    public void E1_ConformanceFixtures_AllPass()
    {
        ...
        InvokeResultMapper mapper = new(Options.Create(new LiaisoOptions()));
        ...
        foreach (string file in files)
        {
            ...
            JsonNode producedNode = JsonSerializer.SerializeToNode(produced, LiaisoJson.Wire)!;
    ...
    private static void AssertSdkFixture(string file, JsonElement sdkCode, JsonElement input, JsonElement expected)
    {
        ...
        SdkError produced = code switch
        {
            ...
            _ => SdkErrors.Create(
                JsonSerializer.Deserialize<SdkErrorCode>($"\"{code}\"", LiaisoJson.Wire),
