...
"Unpinned areas" section listing behaviour that is deliberately not settled; `caching.md` is
normative only in part; `argument-mapping.md` is validated by two implementations but not yet
