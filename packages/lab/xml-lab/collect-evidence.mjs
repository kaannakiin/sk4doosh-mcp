...
const probes = [
  {
    ...
    command: "node packages/lab/xml-lab/test/probes/surface.mjs",
  },
  {
    task: "F0-02",
  ...
  },
  {
    ...
    command: "node packages/lab/xml-lab/test/probes/namespace.mjs",
  },
  {
    task: "F0-04",
    probe: "encoding",
    ...
    options: { execArgv: ["--max-old-space-size=768"], timeoutMs: 240_000 },
    command: "node packages/lab/xml-lab/test/probes/encoding.mjs",
  },
  {
    task: "F0-05",
    probe: "security",
    ...
    options: { execArgv: ["--max-old-space-size=768"], timeoutMs: 240_000 },
    command: "node packages/lab/xml-lab/test/probes/security.mjs",
  },
  {
    task: "F0-06",
    ...
    command: "node packages/lab/xml-lab/test/probes/worker-lifecycle.mjs",
  },
  {
    task: "F0-07",
    ...
    command:
      "node --expose-gc packages/lab/xml-lab/test/probes/resource-lifetime.mjs",
  },
  {
    task: "F0-08",
    probe: "budget",
