...
Adım 1 ve 2 küçük spec değişikliği + fixture ile kapanır. **Adım 5 sıradan çıktı ve önce sevk edildi** — gerekçesi ve sonucu §7'de. **Adım 1 iki yarısıyla da kapandı: `outputSchema` §8'de, payload bütçesi ve timeout §9'da; adım 2 §10'da, adım 3'ün `detail` yarısı §11'de.** Adım 3 §12 ile tümüyle kapandı; adım 6 ve §4.9 talep gelince.
