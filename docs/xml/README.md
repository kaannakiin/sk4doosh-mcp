...
| -------------------------------------------------------------------- | ------------------------------------------------------ | ----------------------------------- | ----------------------------------------------- |
| [F0 — Kanıt ve teknik karar kapısı](fazlar/00-kanit-ve-karar.md)     | XML motorunun gerçek paket üzerinde doğrulanması       | Excel/file-core kapısı geçti        | Başlanmadı; sıradaki faz                        |
