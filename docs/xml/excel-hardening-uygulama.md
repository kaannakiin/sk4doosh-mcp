...
- Commit kanıtı: bu dosyanın ve aşağıdaki kaynak/test dosyalarının Git geçmişi; uygulama commit kimliği son kayıt bölümünde tutulur. Çalıştırılmamış kontroller başarılı sayılmaz.
