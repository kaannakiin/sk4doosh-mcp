...
| Nerede                                     | Ne                                                                                                                                                                                                                                                               |
| ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [F1](fazlar/01-ortak-cekirdek-ve-excel.md) | F1-03 worker kaynak sahipliğinin uygulaması; tasarım kararı F0-07 ile verildi ve `file-core` disposal hook'u gerekmedi. F1-05'in XML yanıt bütçesi, F1-06'nın XML tüketici entegrasyonu. **Üçü de uygulandı**; ölçümler [F1 kapanış kaydında](xml-f1-kapanis.md) |
| [F2](fazlar/02-okuma-mvp.md)               | Dört tool. F2-01/02/03 F1 kapanışıyla teslim edildi; F2-04–11 açık. Yanıt zarfı kapısı kuruldu, **sayfa bütçesi hâlâ F2-08'de ölçülür**                                                                                                                          |
