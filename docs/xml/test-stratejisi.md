...
Durum: F0 kapsamındaki XML testleri uygulandı ve [10/10 platform CI](f0-kanit-kaydi.md) ile geçti (T05/T06 → F0-04, T07/T08 → F0-05, T09 → F0-05/08, T16 → F0-06, T17 → F0-07). F1 kapanışıyla **T08, T15, T16 ve T17'nin ürün kodu ayakları** uygulandı. **F2 kapanışıyla T01, T02, T03, T04, T12'nin cursor ayağı, T13'ün sayfa ayağı ve T14 kapandı**; kanıt [F2 kapanış kaydında](xml-f2-kapanis.md). Dört paketli toplam **612 test** (F1: 529), `xml-mcp` 40 → **123**. T18–T23 F3/F4/F5'e aittir ve açıktır (2026-09-09). Agent kabul kaydı F2-09 ile alındı; XML benchmark'ı hâlâ yok.
