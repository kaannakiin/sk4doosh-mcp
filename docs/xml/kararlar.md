...
Küçük ve orta boyutlu belgeler için `libxml2-wasm` seçildi. Kontrol tarihinde npm `latest` sürümü `0.7.2`; uygulama başladığında sürüm, bütünlük değeri ve beraberindeki libxml2 sürümü tekrar kaydedilecek, başlangıç bağımlılığı tam sürüme sabitlenecek. Araştırmadaki `^0.7.2` ifadesi sabitleme değildir.
