...
**Uygulandı** ([F4 kapanışı](xml-f4-kapanis.md)): parçalı kademe indi, tüketiciye görünen yüzeyi [karar 020](../kararlar/020-parcali-kademe-yuzeyi.md)'dedir. İki nokta bu maddeye eklendi. Birincisi, reddedilen encoding listesi UTF-16 ile bitmiyor: sentetik parça XML bildirimini kaybettiği için UTF-8 dışı **bildirilmiş** encoding de reddediliyor (M31). İkincisi, "indeks baştan kurulmaz" duruşu korundu ama bedeli ölçüldü: span tablosu `maxItemVisits` bütçesinde kesiliyor ve bugün bir pencerede en fazla o kadar kayda erişiliyor (M30). Byte ipucu bu yüzden pencereyi ilerleten mekanizma oldu.
